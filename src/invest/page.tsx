...
import { submitInvestment } from '../utils/api'; // Import the API function instead of appwrite
...
// Add TypeScript interfaces for data and response
...
function InvestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Set the submission ID from API response
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li className="flex items-start gap-3">
            ...
            <a href="mailto:invest@theraiot.com" className="text-gray-600 hover:text-purple-600 text-sm">info@bricklabsai.org</a>
          </li>
          <li className="flex items-start gap-3">
            <svg className="w-5 h-5 text-gray-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
