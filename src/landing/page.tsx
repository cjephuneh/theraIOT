            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 bg-purple-100 px-4 py-2 rounded-full mb-6 animate-pulse">
                ...
                <span className="text-purple-800 font-medium">
                  New: Version 1.0 - Limited Release
                </span>
              </div>
              <h2 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
                AI-Powered{" "}
                <span className="text-purple-600">Emotional Support</span>{" "}
                Companion
              </h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                TheraIOT combines advanced AI, real-time biometric sensing, and
                personalized learning to provide therapeutic comfort for
                children and adults alike.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/preorder"
                  className="bg-purple-600 text-white px-8 py-3 rounded-full hover:bg-purple-700 transition text-lg font-medium flex items-center gap-2 shadow-lg shadow-purple-200"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Our AI-powered companion uses multiple technologies to create a
              truly therapeutic experience that adapts to your unique emotional
              needs.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 shadow-lg shadow-purple-100/50 hover:shadow-xl transition hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                Advanced biometric sensors detect subtle emotional changes and
                respond with comforting actions.
              </p>
              <a
                href="#"
                className="inline-flex items-center text-purple-600 font-medium mt-4 hover:text-purple-700"
              >
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 shadow-lg shadow-purple-100/50 hover:shadow-xl transition hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                Engage in meaningful conversations with advanced language
                processing optimized for emotional support.
              </p>
              <a
                href="#"
                className="inline-flex items-center text-purple-600 font-medium mt-4 hover:text-purple-700"
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 shadow-lg shadow-purple-100/50 hover:shadow-xl transition hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                Military-grade encryption with all processing done on-device for
                complete privacy.
              </p>
              <a
                href="#"
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 shadow-lg shadow-purple-100/50 hover:shadow-xl transition hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                Personalized responses that evolve by learning your emotional
                patterns over time.
              </p>
              <a
                href="#"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  TheraIOT adapts its interaction style based on the user's age,
                  preferences, and emotional needs. From comforting children
                  during stressful times to providing mindfulness guidance for
                  adults.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700">
                      Age-appropriate conversations and responses
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-1 flex-shrink-0" />
                    <p className="text-gray-700">
                      Customizable comfort levels and interaction styles
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-1 flex-shrink-0" />
                    <p className="text-gray-700">
                      Parent controls and monitoring through companion app
                    </p>
                  </li>
                </ul>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover how our therapeutic companion works through an
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
                ...
                <p className="text-gray-600">
                  Our neural processing system understands emotions through
                  voice patterns, facial expressions, and biometric data to
              ...
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
                ...
                <p className="text-gray-600">
                  Build a genuine emotional bond with a companion that actively
                  responds to your emotional needs and adapts to your personal
                  patterns.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
                ...
                <p className="text-gray-600">
                  ...
                  personality traits, and integration with your smart home
                  ecosystem.
                </p>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Pre-order now to secure your TheraIOT at our special introductory
              prices with exclusive early adopter benefits.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition hover:-translate-y-1 hover:shadow-2xl border border-gray-100">
              <div className="p-8 border-b border-gray-100">
                ...
                <p className="text-gray-600 mb-6">
                  Perfect for individual users seeking emotional support.
                </p>
                <Link
                  to="/preorder"
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-600">
                      Basic emotional response system
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      6-month cloud subscription
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-2xl shadow-xl overflow-hidden transition hover:-translate-y-1 hover:shadow-2xl border-2 border-purple-200 transform scale-105">
              ...
              <div className="p-8 border-b border-purple-100">
                ...
                <p className="text-gray-600 mb-6">
                  Enhanced features for deeper emotional support and
                  personalization.
                </p>
                <Link
                  to="/preorder"
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition hover:-translate-y-1 hover:shadow-2xl border border-gray-100">
              <div className="p-8 border-b border-gray-100">
                ...
                <p className="text-gray-600 mb-6">
                  Complete package for families needing multiple support
                  options.
                </p>
                <Link
                  to="/preorder"
              ...
              <div className="p-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Two TheraIOT companions
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Family account with 5 profiles
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="text-green-500 w-5 h-5 mt-0.5 flex-shrink-0" />
          ...
          <div className="mt-16 bg-gray-50 p-8 rounded-2xl max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                ...
                <p className="text-gray-600">
                  We offer special packages for healthcare providers, schools,
                  and organizations.
                </p>
              </div>
              ...
              <table className="min-w-full bg-white rounded-xl overflow-hidden shadow-lg">
                <thead className="bg-purple-50">
                  <tr>
                    ...
                    <th className="py-4 px-6 text-center bg-purple-100 text-purple-800 font-semibold">
                      Premium
                    </th>
                    <th className="py-4 px-6 text-center text-gray-700 font-semibold">
                      Family
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h4 className="font-bold text-lg mb-2">
                How does TheraIOT sense emotions?
              </h4>
              <p className="text-gray-600">
                TheraIOT uses a combination of voice analysis, facial
                recognition, and biometric sensors to detect subtle emotional
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600">
                Absolutely. All emotional data is processed locally on the
                device. Any cloud data is fully encrypted and anonymized, with
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600">
                TheraIOT has an all-day battery life of approximately 18 hours
                with typical use, and recharges fully in just 2 hours.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h4 className="font-bold text-lg mb-2">
                Can multiple people use the same TheraIOT?
              </h4>
              <p className="text-gray-600">
                Yes, Premium and Family packages support multiple user profiles,
                each with personalized responses and tracking.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Join us on our mission to revolutionize therapeutic technology and
              make emotional support accessible to all.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-6">
                Support TheraIOT with capital investment and become a
                stakeholder in our growth.
              </p>
              <Link
                to="/invest"
                className="text-purple-600 font-medium flex items-center gap-2 hover:text-purple-800"
              >
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-6">
                Contribute your technical expertise to help develop our
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-6">
                Explore strategic partnership opportunities with TheraIOT for
                market expansion.
              </p>
              <Link
                to="/invest"
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600 mb-6">
                Help shape our product by contributing to research and clinical
                testing.
              </p>
              <Link
                to="/invest"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-10 opacity-90">
              Limited quantities available for our first production run. Secure
              yours today to be among the first to experience TheraIOT.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/preorder"
                className="bg-white text-purple-700 px-8 py-4 rounded-full text-lg font-medium hover:bg-gray-100 transition shadow-lg"
              >
                Pre-order Now
              </Link>
      ...
      <footer className="bg-gray-900 text-gray-300">
        <div className="container mx-auto px-4 py-12">
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
            <p>
              &copy; {new Date().getFullYear()} TheraIOT Inc. All rights
              reserved.
            </p>
          </div>
        </div>
